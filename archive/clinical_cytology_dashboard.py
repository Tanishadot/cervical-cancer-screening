...
def preprocess_image_clinical(image: Image.Image) -> torch.Tensor:
...
def create_bethesda_display(bethesda_result: dict) -> None:
...
def create_feature_analysis_panels(result: dict) -> None:
...
def create_clinical_reasoning_panel(result: dict) -> None:
...
def create_visual_analysis_section(result: dict, original_image: np.ndarray) -> None:
...
def create_export_section(result: dict) -> None:
    ...
    with col3:
        ...
        summary = f"""
Clinical Cytology Analysis Report
================================
